...
import { dateToSQLite, dateFromSQLite } from "@/storage/database/sqlite/types/datetime";
...
export async function getMemo(database: Database, args: GetMemoArgs, abort?: AbortSignal): Promise<GetMemoRow | null> {
    let result = await database.queryOne(getMemoQuery, [args.publicId], abort);
    if (result === undefined) {
        return null;
    }
    return mapRowToObj<GetMemoRow>(result, { isArchived: numberToBool, isDeleted: numberToBool, createdAt: dateFromSQLite, updatedAt: dateFromSQLite });
}
...
export async function listMemos(database: Database, args: ListMemosArgs, abort?: AbortSignal): Promise<ListMemosRow[]> {
    let result = await database.query(listMemosQuery, [dateToSQLite(args.pageAfter), args.withCreatedAt, args.createdAt, args.withCreatedAtOrOlder, args.createdAtOrOlder, args.withIsArchived, args.isArchived, args.withIsDeleted, args.isDeleted, args.pageSize], abort);
    return result.map(row => mapRowToObj<ListMemosRow>(row, { isArchived: numberToBool, isDeleted: numberToBool, createdAt: dateFromSQLite, updatedAt: dateFromSQLite }));
}
...
export async function listMemosForTag(database: Database, args: ListMemosForTagArgs, abort?: AbortSignal): Promise<ListMemosForTagRow[]> {
    let result = await database.query(listMemosForTagQuery, [dateToSQLite(args.pageAfter), args.tag, args.withCreatedAt, args.createdAt, args.withCreatedAtOrOlder, args.createdAtOrOlder, args.withIsArchived, args.isArchived, args.withIsDeleted, args.isDeleted, args.pageSize], abort);
    return result.map(row => mapRowToObj<ListMemosForTagRow>(row, { isArchived: numberToBool, isDeleted: numberToBool, createdAt: dateFromSQLite, updatedAt: dateFromSQLite }));
}
...
export async function listMemosWithSearch(database: Database, args: ListMemosWithSearchArgs, abort?: AbortSignal): Promise<ListMemosWithSearchRow[]> {
    let result = await database.query(listMemosWithSearchQuery, [dateToSQLite(args.pageAfter), args.search, args.withCreatedAt, args.createdAt, args.withCreatedAtOrOlder, args.createdAtOrOlder, args.withIsArchived, args.isArchived, args.withIsDeleted, args.isDeleted, args.pageSize], abort);
    return result.map(row => mapRowToObj<ListMemosWithSearchRow>(row, { createdAt: dateFromSQLite, updatedAt: dateFromSQLite }));
}
...
export async function listMemosForTagWithSearch(database: Database, args: ListMemosForTagWithSearchArgs, abort?: AbortSignal): Promise<ListMemosForTagWithSearchRow[]> {
    let result = await database.query(listMemosForTagWithSearchQuery, [dateToSQLite(args.pageAfter), args.tag, args.search, args.withCreatedAt, args.createdAt, args.withCreatedAtOrOlder, args.createdAtOrOlder, args.withIsArchived, args.isArchived, args.withIsDeleted, args.isDeleted, args.pageSize], abort);
    return result.map(row => mapRowToObj<ListMemosForTagWithSearchRow>(row, { createdAt: dateFromSQLite, updatedAt: dateFromSQLite }));
}
...
export async function createMemo(database: Database, args: CreateMemoArgs, abort?: AbortSignal): Promise<CreateMemoRow | null> {
    let result = await database.queryOne(createMemoQuery, [args.publicId, args.content, dateToSQLite(args.createdAt)], abort);
    if (result === undefined) {
        return null;
    }
...
export async function updateMemoContent(database: Database, args: UpdateMemoContentArgs, abort?: AbortSignal) {
...
export async function seteMemoArchiveStatus(database: Database, args: SeteMemoArchiveStatusArgs, abort?: AbortSignal) {
...
export async function setMemoDeletionStatus(database: Database, args: SetMemoDeletionStatusArgs, abort?: AbortSignal) {
...
export async function listTags(database: Database, args: ListTagsArgs, abort?: AbortSignal): Promise<ListTagsRow[]> {
    let result = await database.query(listTagsQuery, [args.pageAfter, args.pageSize], abort);
    return result.map(row => mapRowToObj<ListTagsRow>(row, { createdAt: dateFromSQLite, updatedAt: dateFromSQLite }));
}
...
export async function updateTagCount(database: Database, args: UpdateTagCountArgs, abort?: AbortSignal) {
    let updateTagCountQueryWithSliceParams = updateTagCountQuery.replace("/*SLICE:tags*/?", [
        ...Array(args.tags.length).keys().map(i => `?${i + 1}`)
    ].join(","));
...
export async function createMemoTagConnection(database: Database, args: CreateMemoTagConnectionArgs, abort?: AbortSignal) {
...
export async function cleanupeMemoTagConnection(database: Database, args: CleanupeMemoTagConnectionArgs, abort?: AbortSignal): Promise<CleanupeMemoTagConnectionRow[]> {
    let cleanupeMemoTagConnectionQueryWithSliceParams = cleanupeMemoTagConnectionQuery.replace("/*SLICE:tags*/?", [
        ...Array(args.tags.length).keys().map(i => `?${i + 2}`)
    ].join(","));
    let result = await database.query(cleanupeMemoTagConnectionQueryWithSliceParams, [args.memoId, ...args.tags], abort);
...
export async function deleteMemoTagConnections(database: Database, args: DeleteMemoTagConnectionsArgs, abort?: AbortSignal): Promise<DeleteMemoTagConnectionsRow[]> {
