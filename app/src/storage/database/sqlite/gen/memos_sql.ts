...
export interface ListMemosArgs {
    pageAfter?: Temporal.ZonedDateTime
...
export async function listMemos(
    ...
    let result = await database.query(
        ...
        [
            ...
            args.withCreatedAt,
            dateToSQLite(args.createdAt),
            args.withCreatedAtOrOlder,
            dateToSQLite(args.createdAtOrOlder),
            args.withIsArchived,
            args.isArchived,
            args.withIsDeleted,
            args.isDeleted,
...
export async function listTags(
    ...
    return result.map((row) =>
        mapRowToObj<ListTagsRow>(row, { createdAt: dateFromSQLite, updatedAt: dateFromSQLite }),
    )
}
